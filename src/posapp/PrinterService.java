...
private static boolean feedPrinter(byte[] b) {
    try {       
        AttributeSet attrSet = new HashPrintServiceAttributeSet(new PrinterName("Canon iP2700 series", null)); //EPSON TM-U220 ReceiptE4
...
//        PrintJobW pjDone = new PrintJobWatcher(job);
